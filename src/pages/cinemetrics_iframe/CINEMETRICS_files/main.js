! function(e) {
    function t(t) {
        for (var o, s, a = t[0], l = t[1], c = t[2], u = 0, m = []; u < a.length; u++) s = a[u], Object.prototype.hasOwnProperty.call(i, s) && i[s] && m.push(i[s][0]), i[s] = 0;
    ...
    10: function(e, t, n) {
        ...
        const i = e => t => {
                t({
                    type: o.c.DATA_LOADED,
                    data: e
                })
            },
            r = e => t => {
                t({
                    type: o.c.SELECT_COLOR_MODE,
                    colorMode: e
                })
            },
            s = e => (t, n) => {
    ...
    15: function(e, t, n) {
        ...
        function p(e) {
            ...
            const n = s()(1, (e.chaptercolors || []).length).map(n => {
                ...
                t += s;
                const a = e.chaptercolors[n - 1].map(e => ({
                    fraction: e["%"],
                    rgb: {
                        r: e.rgb[0] / 255,
                        g: e.rgb[1] / 255,
                ...
                })).filter(e => null !== e.fraction).map(e => (e.fraction *= 2.5, e));
                return {
                    startframe: o,
                    endframe: i,
                    duration: r,
            ...
            if (n.length) {
                ...
                a = a.map(t => {
                    const o = n[e].angle;
                    return t.angle > o && e++, e > n.length - 1 && (e = n.length - 1), t.chapterIndex = e, t
                })
            }
            return {
                title: e.title,
        ...
        function f(e, t, n) {
            ...
            return o.forEach((i, c) => {
                const d = 0 === c ? 0 : o[c - 1].angle,
                    p = i.angle,
                    f = (n || t) === m.f.CHAPTER && e.chapters.length && e.chapters[i.chapterIndex] ? e.chapters[i.chapterIndex].colors : e.movieColors;
                let v = 0;
                const g = Math.sin(d),
                    b = Math.cos(d),
                    E = Math.sin(p),
                ...
                f.forEach(e => {
                    ...
                    const c = u()(v, 0, 1),
                        ...
                        p = [E, y, o, i.motion],
                        f = [g, b, o, i.motion];
                    r.push(...d, ...m, ...f, ...f, ...m, ...p), a.push(...h), s()(0, h.length / 3).forEach(() => {
                        l.push(n.r, n.g, n.b)
                    })
                })
            }), i.setAttribute("position", new c.a(new Float32Array(a), 3)), i.setAttribute("color", new c.a(new Float32Array(l), 3)), i.setAttribute("sinCosOffsetMotion", new c.a(new Float32Array(r), 4)), i
        }
    ...
    29: function(e, t, n) {
        ...
        t.a = function() {
            ...
            return t.type === o.c.DATA_LOADED ? {...e, movies: t.data.movies, presets: t.data.presets
            } : t.type === o.c.SELECT_COLOR_MODE ? {...e, colorMode: t.colorMode
            } : t.type === o.c.SELECT_MOVIES ? {...e, selectedMovies: t.movies
            } : e
        }
    },
    34: function(e, t, n) {
        ...
        var o = n(1);
        const i = () => {
                // console.log(`${o.d} ${o.e}`), console.log("NODE_ENV: production"), console.log("URL_PREFIX: /")
            },
    ...
    50: function(e, t, n) {
        ...
        function r() {
            return fetch("data/movies.json").then(e => e.json()).then(e => {
                const t = i()(e.movies).map(t => {
                    const n = "data/" + e.movies[t];
                ...
                render() {
                    ...
                    return e.createElement("div", {
                        ...
                        className: o `
									...
									margin-left: -${u.g}px;
								`
                    }))] : m, e.createElement(s.a, {
                        path: "/info",
                        render: () => e.createElement("div", {
                            className: o `
								position: fixed;
...
`,
                f = function(t, n) {
                    let i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "left";
		...
		`
                ...
                v = t => {
                    ...
                    return o.createElement(i, null, f(n, s, "left"), f(n, s, "right"), o.createElement("div", {
                        className: e `
				${h};
				left: 0;
				z-index: 99;
			...
			`
						...
						`
                            ...
                            className: e `
								...
								margin-top: 3px;
							`
                        }, l.director, o.createElement("br", null), l.year) : null)
                    })))
                };
            v.propTypes = {
        ...
        (function(e, o) {
            ...
            const h = t => {
                ...
                return e.createElement("select", {
                    ...
                    value: ""
                }), l.map(t => e.createElement("option", {
                    key: t,
                    value: t,
                    disabled: r()(t, s)
                }, t)))
...
`,
                ...
                E = e => Math.min(.9 * window.innerHeight, e),
                y = (e, t) => (e + 1) * t - .5 * t,
            ...
            class M extends o.Component {
                constructor(e) {
                    ...
                    this.start = function() {
                        ...
                        this.frameId = window.requestAnimationFrame(this.update), t++, this.scene.children.forEach(e => {
                            e.material.uniforms.time.value = .15 * t, e.material.uniforms.time.needsUpdate = !0
                        }), this.renderer.render(this.scene, this.camera)
                    }.bind(this), this.updateData = this.updateData.bind(this), this.handleMouseMove = this.handleMouseMove.bind(this), this.handleMouseDown = this.handleMouseDown.bind(this), this.handleMouseUp = this.handleMouseUp.bind(this)
                }
                componentDidMount() {
                    const e = this.mount.clientWidth,
                        t = this.mount.clientHeight;
                    this.scene = new d.f, this.camera = new d.e(-.5 * e, .5 * e, .5 * t, -.5 * t, 0, 1), this.camera.position.z = 0, this.renderer = new d.i(b), this.renderer.setPixelRatio(window.devicePixelRatio), this.renderer.setSize(e, t), this.renderer.domElement.id = "canvas", this.mount.appendChild(this.renderer.domElement), this.updateData(this.props.movies, this.props.colorMode)
                }
                componentWillUnmount() {
                    this.stop(), this.controls.dispose(), this.mount.removeChild(this.renderer.domElement)
                }
                ...
                updateData(e, t) {
                    ...
                    this._centers = e.map((e, o) => {
                        ...
                        s.horizontalOffset = a - .5 * window.innerWidth;
                ...
                handleMouseMove(e) {
                    ...
                    const {
                        movies: r
                    } = this.props, s = r[o], a = new d.h(t, n), l = this._centers[o];
                    if (l.distanceTo(a) > .4 * w(r.length)) return this.renderer.domElement.style.cursor = "default", void x();
                    if (s.stills && (this.renderer.domElement.style.cursor = "zoom-in"), !this.mouseDown || !s.stills) return void x();
                    const c = a.sub(l);
                    ...
                    })(((e, t) => `data/movies/${t}/stills/${e}`)(s.stills[f], s.title), t, n, s.height)
                }
                handleMouseDown(e) {
                ...
                render() {
                    const {
                        movies: t
                    } = this.props, n = c()(a()(void 0))(t);
                    let r, s;
                    return n >= 0 && (s = w(t.length), r = y(n, s)), o.createElement(i, null, o.createElement("div", {
                        className: g,
                        ref: e => {
                            this.mount = e
                        },
...
`,
		...
		`
			...
			`
				...
				`
                    ...
                    }, "Options:"), o.createElement("div", null, o.createElement("div", {
                        className: l
                    ...
                    }, "Movie colors")), o.createElement("div", {
                        className: l
                    }, o.createElement("input", {
                        type: "checkbox",
                    ...
                    }, "Chapter colors")))), o.createElement("div", null, o.createElement("div", {
                        className: e `
						display: inline-block;
						margin-right: 1rem;
					`
                    }, "Presets:"), o.createElement("select", {
                        value: "",
                        onChange: e => {
                            n(Object(a.d)(e.target.value))
                        }
                    }, o.createElement("option", {
                        value: "",
                        disabled: !0
                    }), Object.keys(i).map(e => o.createElement("option", {
                        key: e,
                        value: e
                    }, e))))))
                };
    ...
    66: function(e, t, n) {
        ...
        (function(e, o, i) {
            var r = n(14),
                s = n(23);
            t.a = () => e.createElement(o, null, e.createElement("div", {
                className: i `
			position: fixed;
			top: 0;
			right: 0;
		...
		`
                ...
                src: "assets/schema_web.png"
            })), e.createElement("p", null, "Part of the project are custom pieces of software – tools for disassembling video files into their components (video, audio, subtitles, etc.) and processing them (shot detection, average shot length, motion measuring, color palettes), as well as an interactive application to generate and visualize different movie fingerprints. Some of the code ", e.createElement("a", {
        ...
        n.r(t),
            function(e) {
                var t = n(68),
                    ...
                    y = n(34);
                Object(y.a)();
                const w = Object(f.createLogger)({
                        collapsed: !0,
                        timestamp: !1
                    }),
                    x = Object(p.b)(g.a, g.b, Object(p.a)(h.a, w)),
                    M = Object(m.b)(a.a)(E.a);
                u.a.render(e.createElement(m.a, {
                    store: x
                }, e.createElement(M, null)), document.getElementById("app")), Object(b.a)().then(e => {
                    x.dispatch(Object(v.a)(e));
                    const t = new URL(window.location.href.split("#/")[0]),
                        n = c.a.parse(t.search);
                    if (n.selection) {
                        const e = n.selection.split(",").map(e => decodeURIComponent(e));
